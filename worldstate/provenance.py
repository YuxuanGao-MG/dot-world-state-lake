...
SOURCES: dict[tuple[str, str], tuple[str, str, str]] = {
    ...
    ("market", "polygon_intraday"): ("immutable", "bar time", "PAID (Polygon): intraday minute bars"),
    ("fundamentals", "fmp_transcripts"): ("immutable", "call date", "PAID (FMP): earnings-call transcripts"),
    ("fundamentals", "fmp_estimates"): ("immutable", "estimate date", "PAID (FMP): analyst estimates/revisions"),
    ("news", "tiingo"):         ("immutable", "publish time", "PAID (Tiingo): premium news"),
    ("alt", "shipping_ais"):    ("immutable", "ping time", "PAID (Datalastic): AIS vessel tracking"),
